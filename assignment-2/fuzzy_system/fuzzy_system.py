...
class FuzzySystem:
    ...
    def add_rule(self, antecedent_clauses: Any, consequent_clauses: Any) -> None:
        ...
        new_rule = FuzzyRule()
        # Write your code below
        for i in antecedent_clauses.keys():
            new_rule.add_antecedent_clause(i, antecedent_clauses[i])
            self.rules.append(new_rule)
        for i in consequent_clauses.keys():
            new_rule.add_consequent_clause(i, consequent_clauses[i])
            self.rules.append(new_rule)
